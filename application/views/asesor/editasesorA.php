            ...
            <div class="card">
                ...
                <div class="card-body">
                    <blockquote class="blockquote mb-0">
                        <?= form_open_multipart('asesor/editAsesorA/' . $asesorA['id']); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select type="text" class="form-control" id="rumpun" name="rumpun">
                                    <?= '<option value="'.$asesorA['rumpun'].'">'. $asesorA['rumpun'].' </option>'; ?>
                                    <?php
                                        for ($i = 0; $i < count($rumpun); $i++){
                                            if ($rumpun[$i] == $asesorA['rumpun']){
                                                continue;
                                            }else{
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                ?>
                                <select type="text" class="form-control" id="rumpun" name="rumpun">
                                    <?= '<option value="'.$asesorA['status_penugasan'].'">'. $asesorA['status_penugasan'].' </option>'; ?>
                                    <?php
                                    for ($i = 0; $i < count($status_penugasan); $i++){
                                        if ($status_penugasan[$i] == $asesorA['status_penugasan']){
                                            continue;
                                        }else{
                        ...
                        <div class="from-group row justify-content-end	">
                            <div class="col-sm-7">
                                <div class="row">
                                    <div class="col-5">
                                        <a href="<?= base_url('asesor/asesorA') ?>"class=" btn btn-secondary btn-icon-split">
