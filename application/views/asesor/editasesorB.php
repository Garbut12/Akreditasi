            ...
            <div class="card">
                ...
                <div class="card-body">
                    <blockquote class="blockquote mb-0">
                        <?= form_open_multipart('asesor/editAsesorB/' . $asesorB['id']); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select type="text" class="form-control" id="rumpun" name="rumpun">
                                    <?= '<option value="'.$asesorB['rumpun'].'">'. $asesorB['rumpun'].' </option>'; ?>
                                    <?php
                                        for ($i = 0; $i < count($rumpun); $i++){
                                            if ($rumpun[$i] == $asesorB['rumpun']){
                                                continue;
                                            }else{
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                ?>
                                <select type="text" class="form-control" id="rumpun" name="rumpun">
                                    <?= '<option value="'.$asesorB['status_penugasan'].'">'. $asesorB['status_penugasan'].' </option>'; ?>
                                    <?php
                                    for ($i = 0; $i < count($status_penugasan); $i++){
                                        if ($status_penugasan[$i] == $asesorB['status_penugasan']){
                                            continue;
                                        }else{
                        ...
                        <div class="from-group row justify-content-end	">
                            <div class="col-sm-7">
                                <div class="row">
                                    <div class="col-5">
                                        <a href="<?= base_url('asesor/asesorB') ?>"class=" btn btn-secondary btn-icon-split">
