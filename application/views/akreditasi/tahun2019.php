...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="<?= base_url('asesor/addasesorA'); ?>" class="btn btn-primary mb-3 " >Add New Asesor A</a>
...
<!--                --><?php //foreach ($asesor as $a) :?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href=""class="badge badge-pill badge-danger" onclick="return confirm('Yakin Hapus?')">delete</a>
                        </td>
                    </tr>
<!--                    --><?php //$i++ ;?>
<!--                --><?php //endforeach; ?>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newAsesorModalLabel">Add New Asesor A</h5>
